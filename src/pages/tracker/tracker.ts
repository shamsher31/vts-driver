...
export class TrackerPage {
  ...
  loadMap() {
    ...
    let sourceLocation: GoogleMapsLatLng = new GoogleMapsLatLng(18.469768, 73.888872);
    let destLocation: GoogleMapsLatLng = new GoogleMapsLatLng(18.506154, 73.874948);
    let busLocation: GoogleMapsLatLng = new GoogleMapsLatLng(18.485133, 73.889623);
